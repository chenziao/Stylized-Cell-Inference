...
from cell_inference.cells.stylized_cell import Stylized_Cell
from cell_inference.utils.currents.ecp import EcpMod
from cell_inference.utils.currents.recorder import Recorder
from cell_inference.utils.currents.point_current import Point_current
...
class Simulation(object):
    def __init__(self, geometry, electrodes, loc_param=[0., 0., 0., 0., 1., 0.], geo_param=[-1], biophys=[-1],
                 gmax=0.015, scale=1.0, ncell=1):
        """
...
def run_am_simulation():
    ...
    groundtruth_lfp = np.array(hf.get('resources'))
    hf.close()
